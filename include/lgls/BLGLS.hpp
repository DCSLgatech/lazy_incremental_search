...
#ifndef LGLS_BLGLS_HPP_
#define LGLS_BLGLS_HPP_
...
public:
  ...
  explicit BLGLS(const ompl::base::SpaceInformationPtr& si);
...
private:
  ...
  std::size_t mHaltonIndex{0}; // depreciated
