...
using lgls::selector::ConstSelectorPtr;
using lgls::selector::SelectorPtr;
...
ompl::base::PlannerStatus GLS::solve(const ompl::base::PlannerTerminationCondition& /*ptc*/) {
  ...
  std::cout << "Total Time to plan : " << time_span.count() << " s" <<std::endl;
...
// ============================================================================
double GLS::getNumberOfVertexExpansions() {
